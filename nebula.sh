...
echo -e "${BLUE}Dashboard:${NC} http://nebula.local (ensure nebula.local points to 127.0.0.1 in /etc/hosts)"
echo -e "${BLUE}API Health:${NC} http://api.nebula.local/health"
echo -e "${BLUE}Initial Credentials:${NC} admin / admin"
